...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/rhtap-qe-java-quarkus:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/obobx3fip-java-quarkus-gitops
